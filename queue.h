...
class queue  
{
  ...
  class Underflow{}; //For when there's an attempt to remove an element of an empty queue
  class Overflow{};//For when there's an attempt to add an element to a full queue
